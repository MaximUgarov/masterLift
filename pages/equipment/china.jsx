...
const China = () => {
    ...
    return (
        <Fragment>
            <Head>
                <title>Лифты и подъемники из Китая - прямые поставки от производителя!</title>
                <meta name="title" content="Лифты и подъемники из Китая - прямые поставки от производителя!" />
                <meta name="description"
                    content="Осуществляем поставки, монтаж и обслуживание лифтового оборудования SJEC и XiZI китайского производства, известных на рынке надежностью и качеством. Звоните!" />
            </Head>
