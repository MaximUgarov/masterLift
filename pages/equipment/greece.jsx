...
const Greece = () => {
    ...
    return (
        <Fragment>
            <Head>
                <title>Лифты Kleemann и Doppler из Греции - прямые поставки от производителя!</title>
                <meta name="title" content="Лифты Kleemann и Doppler из Греции - прямые поставки от производителя!" />
                <meta name="description"
                    content="Осуществляем поставки, монтаж и обслуживание греческого лифтового оборудования фирм Клеман и Допплер — надежных производителей, известных качеством своей продукции. Звоните!" />
            </Head>
